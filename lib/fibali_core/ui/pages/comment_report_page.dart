...
import 'package:fibali/fibali_core/models/comment_report.dart';
...
class CommentReportPage extends StatefulWidget {
  ...
  static Future<dynamic>? show({
    ...
    return Get.to(() => CommentReportPage(
  ...
  @override
  CommentReportPageState createState() => CommentReportPageState();
}

class CommentReportPageState extends State<CommentReportPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            'Reported post from ${widget.reportedUserName}',
  ...
  Future<void> reportMessage({
    ...
    final report = ReportComment(
      ...
      commentRef: widget.documentRef.path,
    );

    return FirebaseFunctions.instance
        .httpsCallable('createCommentReport')
        .call(report.toJson())
        .then((value) {
      EasyLoading.dismiss();
      Get.dialog(
