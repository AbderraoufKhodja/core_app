...
class ChatReportPage extends StatefulWidget {
  ...
  @override
  ChatReportPageState createState() => ChatReportPageState();
}

class ChatReportPageState extends State<ChatReportPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          Text(
            'Reported user: ${widget.reportedUser.name}',
  ...
  Future<void> reportMessage({
    ...
    final needLogIn = await BlocProvider.of<AuthBloc>(context).needLogIn();
    if (needLogIn) {
      return;
    }
    ...
    final report = ReportPersonalChat(
    ...
    return FirebaseFunctions.instance
        .httpsCallable('createPersonalChatReport')
        .call(report.toJson())
        .then((value) {
      EasyLoading.dismiss();
      Get.dialog(
