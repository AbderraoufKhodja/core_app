class AlgeriaCities {
  static List<String> getProvinces() {
    return algeria_cities.map((city) => city["wilaya_name_ascii"].toString()).toSet().toList();
  }

  static List<String> getSubProvinces({required String province}) {
    return algeria_cities
        .where((city) => city["wilaya_name_ascii"] == province)
        .map((city) => city["daira_name_ascii"].toString())
        .toSet()
        .toList();
  }

  static List<String> getSubSubProvinces({
    required String province,
    required String subProvince,
  }) {
    return algeria_cities
        .where((city) => city["wilaya_name_ascii"] == province)
        .where((city) => city["daira_name_ascii"] == subProvince)
