...
import 'package:fibali/mini_apps/medical_appointment/models/md_doctor.dart';
import 'package:fibali/mini_apps/medical_appointment/models/md_doctor_category.dart';
import 'package:fibali/mini_apps/medical_appointment/models/md_patient.dart';
import 'package:fibali/mini_apps/medical_appointment/ui/home/widgets/home_widgets.dart';
    ...
    return Scaffold(
      body: Stack(
        ...
        children: <Widget>[
          ...
          //----BOTTOM BODY ITEMS
          //-----------------------------------
          _BodyHome(contentPadding: EdgeInsets.only(top: heightCurtain - 20)),
          //-----------------------------------
          //----TOP BODY WIDGETS
          //-----------------------------------
          AnimatedPositioned(
