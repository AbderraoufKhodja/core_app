...
class FilterPageState extends State<FilterPage> {
  ...
  DiscoverCubit get _categoriesBloc => BlocProvider.of<DiscoverCubit>(context);
          ...
          Hero(
            ...
            child: BackdropFilter(
              ...
              child: SizedBox.expand(
                child: ColoredBox(
                  color: Colors.deepOrange[300]!.withOpacity(.2),
                ),
              ),
            ),
          ),
...
class _CategoryChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bloc = BlocProvider.of<PostCategoriesBloc>(context);
    return Hero(
      tag: 'chip-$category',
