...
class FutureFirestoreServerCacheQueryBuilder<T> extends StatefulWidget {
  const FutureFirestoreServerCacheQueryBuilder({
    super.key,
    required this.query,
  ...
  @override
  FutureFirestoreServerCacheQueryBuilderState<T> createState() =>
      FutureFirestoreServerCacheQueryBuilderState<T>();
}

class FutureFirestoreServerCacheQueryBuilderState<T>
    extends State<FutureFirestoreServerCacheQueryBuilder<T>> {
