...
class CategoriesDropdownState extends State<CategoriesDropdown> {
  ...
  SwapFactoryBloc get _itemFactoryBloc => BlocProvider.of<SwapFactoryBloc>(context);
      ...
      children: [
        Padding(
          ...
          child: CategoriesDropdownItem(
              ...
              value: _itemFactoryBloc.swapItem.category1,
              onChanged: (value) {
                if (value != null) {
                  _itemFactoryBloc.swapItem.category1 = value;
                  _categories2 = _getSubCategories(value);
                  _categoriesLabels2 = _getSubLabelsCategories(value);
                  _itemFactoryBloc.swapItem.category2 = null;
                  _categories3 = [];
                  _categoriesLabels3 = [];
                  _itemFactoryBloc.swapItem.category3 = null;
                  _categories4 = [];
                  _categoriesLabels4 = [];
                  _itemFactoryBloc.swapItem.category4 = null;
                  _categories5 = [];
                  _categoriesLabels5 = [];
                  _itemFactoryBloc.swapItem.category5 = null;
                  _categories6 = [];
                  _categoriesLabels6 = [];
                  _itemFactoryBloc.swapItem.category6 = null;
                }
                setState(() {});
              }),
        ),
        if (_categories2.isNotEmpty)
          Padding(
            ...
            child: CategoriesDropdownItem(
                ...
                value: _itemFactoryBloc.swapItem.category2,
                onChanged: (value) {
                  if (value != null) {
                    _itemFactoryBloc.swapItem.category2 = value;
        ...
        if (_categories3.isNotEmpty)
          Padding(
            ...
            child: CategoriesDropdownItem(
                ...
                hint: RCCubit.instance.getText(R.addSubCategory),
                value: _itemFactoryBloc.swapItem.category3,
                onChanged: (value) {
                  if (value != null) {
                    _itemFactoryBloc.swapItem.category3 = value;
        ...
        if (_categories4.isNotEmpty)
          Padding(
            ...
            child: CategoriesDropdownItem(
                ...
                hint: RCCubit.instance.getText(R.addSubCategory),
                value: _itemFactoryBloc.swapItem.category4,
                onChanged: (value) {
                  if (value != null) {
                    _itemFactoryBloc.swapItem.category4 = value;
        ...
        if (_categories5.isNotEmpty)
          Padding(
            ...
            child: CategoriesDropdownItem(
                ...
                hint: RCCubit.instance.getText(R.addSubCategory),
                value: _itemFactoryBloc.swapItem.category5,
                onChanged: (value) {
                  if (value != null) {
                    _itemFactoryBloc.swapItem.category5 = value;
        ...
        if (_categories6.isNotEmpty)
          Padding(
            ...
            child: CategoriesDropdownItem(
                ...
                hint: RCCubit.instance.getText(R.addSubCategory),
                value: _itemFactoryBloc.swapItem.category6,
                onChanged: (value) {
                  if (value != null) {
                    _itemFactoryBloc.swapItem.category6 = value;
                  }
                  setState(() {});
                }),
          ),
  ...
  void initCategories() {
    if (_itemFactoryBloc.swapItem.category1 is String) {
      _categories2 = _getSubCategories(_itemFactoryBloc.swapItem.category1!);
      _categoriesLabels2 = _getSubLabelsCategories(_itemFactoryBloc.swapItem.category1!);
    }
    if (_itemFactoryBloc.swapItem.category2 is String) {
      _categories3 = _getSubCategories(_itemFactoryBloc.swapItem.category2!);
      _categoriesLabels3 = _getSubLabelsCategories(_itemFactoryBloc.swapItem.category2!);
    }
    if (_itemFactoryBloc.swapItem.category3 is String) {
      _categories4 = _getSubCategories(_itemFactoryBloc.swapItem.category3!);
      _categoriesLabels4 = _getSubLabelsCategories(_itemFactoryBloc.swapItem.category3!);
    }
    if (_itemFactoryBloc.swapItem.category4 is String) {
      _categories5 = _getSubCategories(_itemFactoryBloc.swapItem.category4!);
      _categoriesLabels5 = _getSubLabelsCategories(_itemFactoryBloc.swapItem.category4!);
    }
    if (_itemFactoryBloc.swapItem.category5 is String) {
      _categories6 = _getSubCategories(_itemFactoryBloc.swapItem.category5!);
      _categoriesLabels6 = _getSubLabelsCategories(_itemFactoryBloc.swapItem.category5!);
    }
  }
