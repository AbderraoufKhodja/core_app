...
class FillLivePostListingTabOne extends StatefulWidget {
  const FillLivePostListingTabOne({Key? key}) : super(key: key);

  @override
  FillLivePostListingTabOneState createState() => FillLivePostListingTabOneState();
}

class FillLivePostListingTabOneState extends State<FillLivePostListingTabOne>
    with AutomaticKeepAliveClientMixin<FillLivePostListingTabOne> {
          ...
          children: [
            ...
            Flexible(
              child: CustomDropdownField(
                ...
                value: _postFactoryBloc.postFromBloc.privacy ?? PostPrivacyType.public.name,
                onChanged: (value) {
                  if (value != null) {
                    setState(
                      () {
                        _postFactoryBloc.postFromBloc.privacy = value;
                      },
                    );
                  }
                },
