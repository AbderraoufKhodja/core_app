...
class RefundClientOrdersTab extends StatefulWidget {
  const RefundClientOrdersTab({Key? key}) : super(key: key);

  @override
  State<RefundClientOrdersTab> createState() => _RefundClientOrdersTabState();
}

class _RefundClientOrdersTabState extends State<RefundClientOrdersTab> {
  AppUser? get _currentUser => BlocProvider.of<AuthBloc>(context).currentUser;

  @override
  Widget build(BuildContext context) {
    return FirestoreQueryBuilder<ShoppingOrder>(
      query: ShoppingOrder.ref.where('clientID', isEqualTo: _currentUser!.uid).where(
        'lastOrderEvent.type',
        whereIn: [
          'refundApplication',
          'declineRefund',
