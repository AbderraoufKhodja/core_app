...
class AddPostPhotosTab extends StatefulWidget {
  const AddPostPhotosTab({Key? key}) : super(key: key);

  @override
  _AddPostPhotosTabState createState() => _AddPostPhotosTabState();
}

class _AddPostPhotosTabState extends State<AddPostPhotosTab>
    with AutomaticKeepAliveClientMixin<AddPostPhotosTab> {
