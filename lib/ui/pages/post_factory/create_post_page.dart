...
import 'package:fibali/ui/pages/post_factory/fill_post_listing_tab_one.dart';
import 'package:fibali/ui/pages/post_factory/fill_post_listing_tab_two.dart';
...
class CreatePostPage extends StatefulWidget {
  const CreatePostPage({Key? key, required this.images}) : super(key: key);
      ...
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            ...
            const FillPostListingTabOne(),
            const FillPostListingTabTwo(),
          ],
        ),
      ),
    );
