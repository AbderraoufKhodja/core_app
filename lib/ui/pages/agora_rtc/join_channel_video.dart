...
// import 'package:fibali/ui/pages/agora_rtc/log_sink.dart';
...
//         logSink.log('networkQuality | txQuality :$txQuality, rxQuality: $rxQuality');
//       },
//       warning: (warningCode) {
...
//     await _engine.joinChannel(widget.token, _controller.text, null, widget.uid);
//   }
...
//                 mainAxisAlignment: MainAxisAlignment.start,
//                 children: [
//                   const Text('Rendered by SurfaceView \n(default TextureView): '),
//                   Switch(
