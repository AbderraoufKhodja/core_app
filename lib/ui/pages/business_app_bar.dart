...
class BusinessAppBar extends AppBar {
  BusinessAppBar({super.key});

  @override
  CustomSliverAppBarState createState() => CustomSliverAppBarState();
}

class CustomSliverAppBarState extends State<BusinessAppBar>
    with AutomaticKeepAliveClientMixin<BusinessAppBar> {
  @override
