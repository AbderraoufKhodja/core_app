...
class FactoryItemCategoriesDropdown extends StatefulWidget {
  const FactoryItemCategoriesDropdown({super.key});

  @override
  FactoryItemCategoriesDropdownState createState() => FactoryItemCategoriesDropdownState();
}

class FactoryItemCategoriesDropdownState extends State<FactoryItemCategoriesDropdown> {
