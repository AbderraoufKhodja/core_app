...
class AllSellerOrdersTab extends StatefulWidget {
  const AllSellerOrdersTab({super.key});

  @override
  State<AllSellerOrdersTab> createState() => _AllSellerOrdersTabState();
}

class _AllSellerOrdersTabState extends State<AllSellerOrdersTab> {
  ...
  Widget build(BuildContext context) {
    return FirestoreQueryBuilder<ShoppingOrder>(
      query: _sellerOrdersCubit.ordersRef.where('storeOwnerID', isEqualTo: _currentUser!.uid),
          ...
          return Center(
            child: Column(
              ...
              children: [
                ...
                Text(
                  RCCubit.instance.getText(R.noOrders),
