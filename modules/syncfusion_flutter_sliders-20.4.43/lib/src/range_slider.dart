...
class SfRangeSlider extends StatefulWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(ObjectFlagProperty<ValueChanged<SfRangeValues>>('onChanged', onChanged,
        ifNull: 'disabled'));
    properties
    ...
    if (values.start.runtimeType == DateTime && dateFormat != null) {
      properties.add(
          StringProperty('dateFormat', 'Formatted value is ${dateFormat!.format(values.start)}'));
    }
...
class _SfRangeSliderState extends State<SfRangeSlider> with TickerProviderStateMixin {
  ...
  SfRangeSliderThemeData _getRangeSliderThemeData(ThemeData themeData, bool isActive) {
    ...
    rangeSliderThemeData = rangeSliderThemeData.copyWith(
      ...
      thumbColor:
          widget.activeColor ?? rangeSliderThemeData.thumbColor ?? themeData.colorScheme.primary,
      activeTickColor:
          rangeSliderThemeData.activeTickColor ?? themeData.colorScheme.onSurface.withOpacity(0.37),
      ...
      inactiveMinorTickColor: rangeSliderThemeData.inactiveMinorTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.37),
      disabledActiveMinorTickColor: rangeSliderThemeData.disabledActiveMinorTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.24),
      disabledInactiveMinorTickColor: rangeSliderThemeData.disabledInactiveMinorTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.24),
      ...
      disabledInactiveDividerColor: rangeSliderThemeData.disabledInactiveDividerColor ??
          themeData.colorScheme.onSurface.withOpacity(0.12),
      disabledActiveDividerColor: rangeSliderThemeData.disabledActiveDividerColor ??
          themeData.colorScheme.onPrimary.withOpacity(0.12),
      disabledActiveTrackColor: rangeSliderThemeData.disabledActiveTrackColor ??
          themeData.colorScheme.onSurface.withOpacity(0.32),
      disabledInactiveTrackColor: rangeSliderThemeData.disabledInactiveTrackColor ??
          themeData.colorScheme.onSurface.withOpacity(0.12),
      ...
      overlappingThumbStrokeColor:
          rangeSliderThemeData.overlappingThumbStrokeColor ?? themeData.colorScheme.surface,
