  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    if (initialValues != null &&
      ...
      properties.add(StringProperty(
          'dateFormat', 'Formatted value is ${dateFormat!.format(initialValues!.start)}'));
    }

    properties.add(ObjectFlagProperty<ValueChanged<SfRangeValues>>.has('onChanged', onChanged));
    properties
        .add(ObjectFlagProperty<ValueChanged<SfRangeValues>>.has('onChangeStart', onChangeStart));
...
class _SfRangeSelectorState extends State<SfRangeSelector> with TickerProviderStateMixin {
  ...
  SfRangeSelectorThemeData _getRangeSelectorThemeData(ThemeData themeData) {
    ...
    final double minTrackHeight = math.min(
        rangeSelectorThemeData.activeTrackHeight, rangeSelectorThemeData.inactiveTrackHeight);
    ...
    rangeSelectorThemeData = rangeSelectorThemeData.copyWith(
      ...
      thumbColor:
          widget.activeColor ?? rangeSelectorThemeData.thumbColor ?? themeData.colorScheme.primary,
      ...
      disabledInactiveTickColor: rangeSelectorThemeData.disabledInactiveTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.24),
      ...
      inactiveMinorTickColor: rangeSelectorThemeData.inactiveMinorTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.37),
      disabledActiveMinorTickColor: rangeSelectorThemeData.disabledActiveMinorTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.24),
      // ignore: lines_longer_than_80_chars
      disabledInactiveMinorTickColor: rangeSelectorThemeData.disabledInactiveMinorTickColor ??
          themeData.colorScheme.onSurface.withOpacity(0.24),
      ...
      disabledInactiveDividerColor: rangeSelectorThemeData.disabledInactiveDividerColor ??
          themeData.colorScheme.onSurface.withOpacity(0.12),
      disabledActiveDividerColor: rangeSelectorThemeData.disabledActiveDividerColor ??
          themeData.colorScheme.onPrimary.withOpacity(0.12),
      disabledActiveTrackColor: rangeSelectorThemeData.disabledActiveTrackColor ??
          themeData.colorScheme.onSurface.withOpacity(0.32),
      disabledInactiveTrackColor: rangeSelectorThemeData.disabledInactiveTrackColor ??
          themeData.colorScheme.onSurface.withOpacity(0.12),
      ...
      overlappingThumbStrokeColor:
          rangeSelectorThemeData.overlappingThumbStrokeColor ?? themeData.colorScheme.surface,
      ...
      activeRegionColor: rangeSelectorThemeData.activeRegionColor ?? Colors.transparent,
...
class _RenderRangeSelector extends RenderBaseRangeSlider {
  ...
  void _handleRangeControllerChange() {
    if (_state.mounted &&
      ...
      values = SfRangeValues(getActualValue(value: _state.widget.controller!.start),
  ...
  void _drawRegions(PaintingContext context, Rect trackRect, Offset offset, Offset startThumbCenter,
    ...
    if (child != null && child!.size.height > 1 && child!.size.width > 1) {
      ...
      context.canvas.drawRect(
          Rect.fromLTRB(
              trackRect.left, offset.dy, leftThumbCenter.dx, trackRect.top + inactiveRegionAdj),
          inactivePaint);
      ...
      context.canvas.drawRect(
          Rect.fromLTRB(
              leftThumbCenter.dx, offset.dy, rightThumbCenter.dx, trackRect.top + activeRegionAdj),
          activePaint);
      context.canvas.drawRect(
          Rect.fromLTRB(
              rightThumbCenter.dx, offset.dy, trackRect.right, trackRect.top + inactiveRegionAdj),
          inactivePaint);
    }
  }
  ...
  void performLayout() {
    ...
    if (child != null) {
      ...
      final BoxConstraints childConstraints = constraints.deflate(EdgeInsets.only(
          left: maxRadius, right: maxRadius, bottom: elementsHeightAfterRenderedChild));
  ...
  @override
  void drawRegions(PaintingContext context, Rect trackRect, Offset offset, Offset startThumbCenter,
      Offset endThumbCenter) {
  ...
  void paint(PaintingContext context, Offset offset) {
    ...
    if (child != null) {
      ...
      if (childHeight >= constraints.maxHeight) {
        childHeight -=
            elementsActualHeight - math.max(actualOverlaySize.height, actualThumbSize.height) / 2;
      }
    }

    final Offset actualTrackOffset = Offset(offset.dx,
        offset.dy + math.max(childHeight - adjustTrackY / 2, trackOffset.dy - maxTrackHeight / 2));
