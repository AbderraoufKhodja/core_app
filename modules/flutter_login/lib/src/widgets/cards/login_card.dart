...
class _LoginCard extends StatefulWidget {
  const _LoginCard({
    ...
    required this.phoneNumberPicker,
  ...
  final Widget? phoneNumberPicker;
...
class _LoginCardState extends State<_LoginCard> with TickerProviderStateMixin {
  ...
  Future<bool> _loginProviderSubmit(
      {required LoginProvider loginProvider, AnimationController? control}) async {
  ...
  Widget _buildUserField(
    ...
    return AnimatedPhoneNumberFormField(
      onInputChanged: widget.onInputChanged,
      initPhoneNumber: widget.initPhoneNumber,
  ...
  Widget _buildPasswordField(double width, LoginMessages messages, Auth auth) {
    return AnimatedPasswordTextFormField(
      sendOTPWidget: GestureDetector(
          onTap: () {
            widget.userValidator?.call(_nameController.text);
          },
          child: widget.sendOTPWidget),
      animatedWidth: width,
      loadingController: widget.loadingController,
      interval: _passTextFieldLoadingAnimationInterval,
  ...
  Widget _buildConfirmPasswordField(double width, LoginMessages messages, Auth auth) {
    return AnimatedPasswordTextFormField(
      sendOTPWidget: widget.sendOTPWidget,
      animatedWidth: width,
