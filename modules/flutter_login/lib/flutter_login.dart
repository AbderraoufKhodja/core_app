...
class _FlutterLoginState extends State<FlutterLogin> with TickerProviderStateMixin {
  ...
  Widget _buildHeader(double height, LoginTheme loginTheme) {
    return _Header(
      ...
      phoneNumberPicker: widget.phoneNumberPicker,
      height: height,
      logo: widget.logo,
  ...
  ThemeData _mergeTheme({required ThemeData theme, required LoginTheme loginTheme}) {
    ...
    final textStyle =
        theme.textTheme.bodyText2!.copyWith(color: blackOrWhite).merge(loginTheme.bodyStyle);
  ...
  Widget build(BuildContext context) {
    ...
    final cardTopPosition =
        loginTheme.cardTopPosition ?? max(deviceSize.height / 2 - cardInitialHeight / 2, 85);
