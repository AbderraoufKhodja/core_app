class AeCategories {
  static List<Map<String, Object>> get parentCategories =>
      aeCategories.where((element) => !element.containsKey("parent_category_id")).toList();

  static List<Map<String, Object>> subCategory(int categoryID) =>
      aeCategories.where((element) => element["parent_category_id"] == categoryID).toList();

  static const aeCategories = [
    // {
    //   "category_name": "Food",
    //   "category_id": 2,
    // },
