...
class _CountrySearchListWidgetState extends State<CountrySearchListWidget> {
  ...
  InputDecoration getSearchBoxDecoration() {
    return widget.searchBoxDecoration ??
        InputDecoration(labelText: 'Search...', contentPadding: EdgeInsets.only(left: 8.0));
  }
...
/// Creates a list of Countries with a search textfield.
class NoDialCodeCountrySearchListWidget extends StatefulWidget {
  final List<Country> countries;
  final InputDecoration? searchBoxDecoration;
  final String? locale;
  final ScrollController? scrollController;
  ...
  NoDialCodeCountrySearchListWidget(this.countries, this.locale,
      {this.searchBoxDecoration,
      this.scrollController,
      this.showFlags,
      this.useEmoji,
  ...
  @override
  _NoDialCodeCountrySearchListWidgetState createState() =>
      _NoDialCodeCountrySearchListWidgetState();
}

class _NoDialCodeCountrySearchListWidgetState extends State<NoDialCodeCountrySearchListWidget> {
  TextEditingController _searchController = TextEditingController();
  late List<Country> filteredCountries;
